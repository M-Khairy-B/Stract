(function (factory) {
	...
	*/
	...
	jquery(document).ready(function () {
	  ...
	  jquery(window).scroll(function () {
	    ...
	    jquery("section").each(function (i) {
	      if (jquery(this).position().top <= scrollDistance) {
	        jquery("ul.navbar-nav a.active").removeClass("active");
	        jquery("ul.navbar-nav a").eq(i).addClass("active");
	      }
	    });
	  }).scroll();
	    ...
	    jquery(window).scroll(function () {
	      ...
	      jquery(".animation").each(function () {
	        ...
	        if (scroll > position - windowHeight) {
	          if (jquery(this).hasClass("more-than")) {
	            setTimeout(function () {
	              jquery(".more-than").addClass("open");
	            }, 200);
	          }

	          if (jquery(this).hasClass("explore")) {
	            setTimeout(function () {
	              jquery(".explore").addClass("open");
	            }, 400);
	          }

	          if (jquery(this).hasClass("cyber-security")) {
	            setTimeout(function () {
	              jquery(".cyber-security").addClass("open");
	            }, 600);
	          }

	          if (jquery(this).hasClass("about-stract")) {
	            setTimeout(function () {
	              jquery(".about-stract").addClass("open");
	            }, 800);
	          }

	          if (jquery(this).hasClass("stract-works")) {
	            setTimeout(function () {
	              jquery(".stract-works").addClass("open");
	            }, 900);
	          }
	        }
	      });
	  ...
	  jquery(".navbar .navbar-brand img").show(500, function () {
	    jquery(".navbar .navbar-nav .nav-item .nav-link").each(function (index) {
